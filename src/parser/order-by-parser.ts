...
import { ExpressionOrFactory, isExpressionOrFactory, parseExpression } from './expression-parser.js';
import { ReferenceExpression, AnyReference, parseStringReference } from './reference-parser.js';
 ...
 */
export type DirectedOrderByStringReference<DB, TB extends keyof DB, O> = `${AnyReference<DB, TB> | (keyof O & string)} ${OrderByDirection}`;
...
export function parseOrderByItem(expr: OrderByExpression<any, any, any>, modifiers?: OrderByModifiers): OrderByItemNode {
...
function parseOrderByExpression(expr: OrderByExpression<any, any, any>): OperationNode {
